...
abstract class BitmapHunter implements Runnable {
	...
	static Bitmap transformResult(Request data, Bitmap result, int exifRotation) {
		...
		if (data.needsMatrixTransform()) {
			int targetWidth = data.targetWidth;// < inWidth ? data.targetWidth :
												// inWidth;
			int targetHeight = data.targetHeight;// < inHeight ?
													// data.targetHeight :
													// inHeight;
			...
			if (data.centerCrop) {
				...
				float widthRatio = (targetWidth < inWidth ? targetWidth
						: inWidth) / (float) inWidth;
				float heightRatio = (targetHeight < inHeight ? targetHeight
		...
		if (swapDimens) {
			newResult = Bitmap.createBitmap(result, drawY, drawX, drawHeight,
					drawWidth, matrix, true);
		} else {
			newResult = Bitmap.createBitmap(result, drawX, drawY, drawWidth,
